        ...
        - list [ref=e123]:
          - listitem [ref=e124]:
            - generic [ref=e125] [cursor=pointer]:
              ...
              - paragraph [ref=e127]: Andreisasa Popescusisi
              - generic [ref=e128]: 
...
```ts
  ...
  11 |             dashboardLocators.dashboardMenu
  12 |         );
  13 |     }
  14 | 
  15 |     async validateDashboardWidgets() {
  16 | 
> 17 |     await expect(
     |     ^ ReferenceError: expect is not defined
  18 |         this.page.locator(dashboardLocators.timeAtWorkWidget)
  19 |     ).toBeVisible();
  20 | 
  21 |     await expect(
  22 |         this.page.locator(dashboardLocators.myActionsWidget)
  23 |     ).toBeVisible();
  24 | 
  25 |     await expect(
  26 |         this.page.locator(dashboardLocators.quickLaunchWidget)
  27 |     ).toBeVisible();
  28 | 
  29 | }
  30 | 
