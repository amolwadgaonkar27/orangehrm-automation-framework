...
> 13 |     await this.page.fill(loginLocators.usernameInput, username);
  ...
  19 |     await this.page.waitForSelector(loginLocators.dashboardHeader, { timeout: 1000 });
  20 |     return this.page.locator(loginLocators.dashboardHeader).isVisible();
  21 |   }
  22 | 
  23 |   async getErrorMessage() {
  24 |     await this.page.waitForSelector(loginLocators.errorMessage, { timeout: 1000 });
