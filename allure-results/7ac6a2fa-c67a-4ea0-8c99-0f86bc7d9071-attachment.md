...
```ts
  ...
  22 | 
> 23 |         expect(await dashboardPage.isTimeAtWorkVisible()).toBeTruthy();
     |                                                           ^ Error: expect(received).toBeTruthy()
  24 |         expect(await dashboardPage.isMyActionsVisible()).toBeTruthy();
  25 |         expect(await dashboardPage.isQuickLaunchVisible()).toBeTruthy();
  26 | 
  27 | });
  28 | 
  29 | });
