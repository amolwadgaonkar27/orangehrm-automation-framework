      ...
      - generic [ref=e160]:
        - generic [ref=e162]:
          ...
          - generic [ref=e174]:
            ...
            - textbox "Type for hints..." [active] [ref=e180]
...
```ts
  ...
  21 |     }
  22 | 
  23 |     async getSuccessMessage() {
> 24 |     await this.page.waitForSelector(
     |                     ^ Error: page.waitForSelector: Test timeout of 30000ms exceeded.
  25 |         adminLocators.successToast
  26 |     );
  27 | 
  28 |     return await this.page
  29 |         .locator(adminLocators.successToast)
  30 |         .textContent();
  31 |     }
  32 | 
  33 |    async createESSUser(employee, username, password) {
  34 | 
  35 |     // User Role
  36 |     // Employee Name
  37 | await this.page.locator(adminLocators.employeeName).click();
  38 | await this.page.locator(adminLocators.employeeName).fill(employee);
  39 | 
  40 | await this.page.waitForSelector('.oxd-autocomplete-dropdown');
  41 | 
  42 | const option = this.page.locator('.oxd-autocomplete-option').first();
  43 | await option.waitFor({ state: 'visible' });
  44 | await option.click();
  45 | 
  46 | // Verify the selected value
  47 | const selectedEmployee = await this.page
  48 |     .locator(adminLocators.employeeName)
  49 |     .inputValue();
  50 | 
  51 | console.log('Selected Employee:', selectedEmployee);
  52 | 
  53 | const suggestions = await this.page
  54 |     .locator('.oxd-autocomplete-option')
  55 |     .allTextContents();
  56 | 
  57 | console.log(suggestions);
  58 | 
  59 | }
  60 | 
  61 | }
  62 | 
  63 | module.exports = AdminPage;
```