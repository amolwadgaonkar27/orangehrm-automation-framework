...
Call log:
  - waiting for getByRole('option', { name: '8' })
        ...
        - list [ref=e123]:
          - listitem [ref=e124]:
            - generic [ref=e125] [cursor=pointer]:
              ...
              - paragraph [ref=e127]: Aminah abuDoe
              - generic [ref=e128]: 
...
```ts
  ...
  39 |         await this.page.getByRole('option', {
  40 |             name: activity
> 41 |                 }).click();
     |                    ^ Error: locator.click: Test timeout of 60000ms exceeded.
  42 |         await this.page.waitForSelector('.oxd-select-dropdown', {
  43 |             state: 'hidden'
  44 | });
