...
- Name: pim.spec.js >> PIM Module >> TC005 - Add Employee
- Location: tests/pim.spec.js:22:5
...
```ts
  ...
  17 |     }
  18 | 
  19 |     async addEmployee(firstName, middleName, lastName) {
  20 |         await this.page.fill(pimLocators.firstName, firstName);
> 21 |         await this.page.fill(pimLocators.middleName, middleName);
     |                         ^ Error: page.fill: value: expected string, got undefined
  ...
  28 |         return await this.page.locator(pimLocators.successMessage).textContent();
  29 | 
  30 |     }
  31 | 
  32 |     async getRequiredMessage() {
  33 |         return await this.page.locator(pimLocators.requiredMessage).first().textContent();
  34 | 
  35 |     }
  36 | 
  37 | }
  38 | 
  39 | module.exports = PimPage;
```