...
```
Error: locator.textContent: Error: strict mode violation: locator('span.oxd-text.oxd-text--span') resolved to 12 elements:
...
Call log:
  - waiting for locator('span.oxd-text.oxd-text--span')
